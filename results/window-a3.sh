...
# benchmarks, restores the full stack. Detached-safe: setsid nohup bash window-a3.sh
set -u
...
RESTORE_LOG="$HOME/Documents/github/linux/results/window-a3-restore.log"
...
touch "$HOME/Documents/github/linux/results/window-a3-DONE"
